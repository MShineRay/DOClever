    ...
    <div class="wrap">
      <div style="padding:0 15px">
        ...
        <template v-else>
          <div class="login fr">
            <ul>
              <li><img v-proxy="session.photo" style="width: 40px;height: 40px; border-radius:50%;margin-top: 25px">&nbsp;
              </li>
              <li>
                <el-dropdown @command="handleCommand"><span class="el-dropdown-link"
                                                            style="color: #50bfff;cursor: pointer">
