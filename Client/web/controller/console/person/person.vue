<template>
  <el-row class="row" style="padding: 10px 10px 60px 10px;height: 100%;overflow-y: auto;font-size: 14px"
          id="personInfo">
    <el-row class="row"
      ...
      <el-row class="row" style="padding: 10px 20px 10px 40px">
        <el-form ref="form" label-width="100px" label-position="top">
          ...
          <el-form-item>
            <el-button type="primary" size="mini" style="width: 100px;margin-top: 10px" @click.prevent="saveInfo"
                       :loading="savePending">
              保存
            </el-button>
          </el-form-item>
    ...
    <el-row class="row"
      ...
      <el-row class="row" style="padding: 10px 20px 10px 40px">
        <el-form ref="form" label-width="100px" label-position="top">
          ...
          <el-form-item>
            <el-button size="mini" type="primary" style="width: 100px;margin-top: 10px" @click.prevent="editPass"
                       :loading="passPending">
              保存
            </el-button>
          </el-form-item>
          ...
          <el-row class="row">
            <el-col class="col" :span="10">
              <el-form-item label="发件人邮箱账户">
                <el-input size="small" placeholder="请输入发件人的邮箱账户(如：aaa@qq.com)" style="width: 90%"
                          v-model="sendInfo.user"></el-input>
              </el-form-item>
            </el-col>
            <el-col class="col" :span="10">
              <el-form-item label="发件人邮箱密码">
                <el-input size="small" placeholder="请输入发件人的邮箱密码" style="width: 90%"
                          v-model="sendInfo.password"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row class="row">
            <el-col class="col" :span="10">
              <el-form-item label="发件人smtp地址">
                <el-input size="small" placeholder="请输入发件人的smtp地址(如：smtp.qq.com)" style="width: 90%"
                          v-model="sendInfo.smtp"></el-input>
              </el-form-item>
            </el-col>
            <el-col class="col" :span="10">
              <el-form-item label="发件人smtp端口">
                <el-input size="small" placeholder="请输入发件人smtp端口号" style="width: 90%"
                          v-model="sendInfo.port"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-form-item>
            <el-button size="mini" type="primary" style="width: 100px;margin-top: 10px" @click.prevent="saveSendInfo"
                       :loading="sendPending">
              保存
            </el-button>
          </el-form-item>
