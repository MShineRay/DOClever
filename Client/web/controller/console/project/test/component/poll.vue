  ...
  <el-dialog :title="propPoll?'编辑轮询':'创建轮询'" width="80%" ref="box" :visible.sync="showDialog" append-to-body>
    ...
    <el-form ref="form" label-width="100px">
      ...
      <el-form-item label="用例失败才发送" style="text-align: center">
        <el-switch v-model="poll.failSend" active-color="#13ce66" inactive-color="#ff4949" :active-value="1"
                   :inactive-value="0"></el-switch>
      </el-form-item>
      <el-form-item label="BaseUrl" style="text-align: center">
        <el-cascader size="small" expand-trigger="hover" :options="arrProjectUrl" v-model="arrSelBaseUrl"
                     style="width: 90%" filterable clearable placeholder="请选择BaseUrl" :props="props"
                     @input="changeBaseUrl">
        </el-cascader>
      </el-form-item>
      <el-tabs type="card">
        <el-tab-pane label="邮箱">
          <el-form-item label="发件人邮箱账户" style="text-align: center">
            <el-input size="small" placeholder="请输入发件人的邮箱账户(如：aaa@qq.com)" style="width: 80%"
                      v-model="poll.sendInfo.user"></el-input>
          </el-form-item>
          <el-form-item label="发件人邮箱密码" style="text-align: center">
            <el-input size="small" placeholder="请输入发件人的邮箱密码" style="width: 80%"
                      v-model="poll.sendInfo.password"></el-input>
          </el-form-item>
          <el-form-item label="发件人smtp地址" style="text-align: center">
            <el-input size="small" placeholder="请输入发件人的smtp地址(如：smtp.qq.com)" style="width: 80%"
                      v-model="poll.sendInfo.smtp"></el-input>
          </el-form-item>
          <el-form-item label="发件人smtp端口" style="text-align: center">
            <el-input size="small" placeholder="请输入发件人smtp端口号" style="width: 80%"
                      v-model="poll.sendInfo.port"></el-input>
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane label="短信">
          ...
          <el-form-item label="URL" style="text-align: center">
            <el-input size="small" placeholder="请输入URL地址" style="width: 80%"
                      v-model="poll.phoneInfo.baseUrl"></el-input>
          </el-form-item>
          <el-form-item label="号码绑定字段" style="text-align: center">
            <el-input size="small" placeholder="请输入绑定到url参数的手机号码字段名称" style="width: 80%"
                      v-model="poll.phoneInfo.bindParam"></el-input>
          </el-form-item>
          <el-form-item label="号码分隔符" style="text-align: center">
            <el-input size="small" placeholder="请输入手机号码分隔符" style="width: 80%"
                      v-model="poll.phoneInfo.split"></el-input>
          </el-form-item>
          <el-form-item label="内容绑定字段" style="text-align: center">
            <el-input size="small" placeholder="请输入绑定到url参数的发送内容的字段名称" style="width: 80%"
                      v-model="poll.phoneInfo.contentParam"></el-input>
          </el-form-item>
          <el-form-item label="签名" style="text-align: center">
            <el-input size="small" placeholder="请输入附加到发送内容的签名" style="width: 80%"
                      v-model="poll.phoneInfo.sign"></el-input>
          </el-form-item>
            ...
            <template v-for="(item,index) in poll.phoneInfo.param">
              <el-row class="row" style="height: 50px;line-height: 50px;width: 90%;display: inline-block">
                <el-col :span="10" class="col">
                  <el-input size="small" placeholder="请输入参数名称" style="width: 80%" v-model="item.key"
                            @input="index==poll.phoneInfo.param.length-1?addParam():''"></el-input>
                </el-col>
                <el-col :span="10" class="col">
