      ...
      <el-tabs v-model="type">
          ...
          <el-row class="row" v-for="(item,index) in param" style="text-align: center;height: 50px;line-height: 50px">
            ...
            <el-col class="col" :span="10">
              <el-input size="small" v-model="item.value" style="width: 90%" placeholder="请输入value"
                        @keypress.native="keyPress($event,item)">
              </el-input>
            </el-col>
            <el-col class="col" :span="2" @click="param.splice(index+1,0,{key:'',value:'',type:'string'})">
              <el-button size="mini" type="text" style="font-weight: 900;font-size: 16px;"
                         icon="el-icon-plus"></el-button>
            </el-col>
            <el-col class="col" :span="2">
              <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;"
                         icon="el-icon-close"
          ...
          <el-row class="row" v-for="(item,index) in query" style="text-align: center;height: 50px;line-height: 50px">
            ...
            <el-col class="col" :span="2">
              <el-button size="mini" type="text" style="font-weight: 900;font-size: 16px;" icon="el-icon-plus"
                         @click="query.splice(index+1,0,{key:'',value:'',type:'string'})"></el-button>
            </el-col>
            <el-col class="col" :span="2">
              <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;"
                         icon="el-icon-close"
        ...
        <el-tab-pane name="header" label="Header">
          <el-row class="row" v-for="(item,index) in header" style="text-align: center;height: 50px;line-height: 50px">
            ...
            <el-col class="col" :span="2">
              <el-button size="mini" type="text" style="font-weight: 900;font-size: 16px;" icon="el-icon-plus"
                         @click="header.splice(index+1,0,{key:'',value:'',type:'string'})"></el-button>
            </el-col>
            <el-col class="col" :span="2">
              <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;"
                         icon="el-icon-close"
        ...
        <el-tab-pane name="body" label="Body">
          <el-row class="row" v-for="(item,index) in body" style="text-align: center;height: 50px;line-height: 50px">
            ...
            <el-col class="col" :span="2">
              <el-button size="mini" type="text" style="font-weight: 900;font-size: 16px;" icon="el-icon-plus"
                         @click="body.splice(index+1,0,{key:'',value:'',type:'string'})"></el-button>
            </el-col>
            <el-col class="col" :span="2">
              <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;"
                         icon="el-icon-close"
