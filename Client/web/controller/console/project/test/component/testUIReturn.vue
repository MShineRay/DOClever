    ...
    <el-row class="row" style="text-align: center;">
      <el-form ref="form" label-width="100px">
        ...
        <el-form-item label="返回参数">
          <el-row class="row" v-for="(item,index) in obj.argv"
            ...
            <el-col class="col" :span="16">
              <el-input size="small" style="width: 90%" v-model="item.value"
                        @keypress.native="keyPress($event,item)"></el-input>
            </el-col>
            <el-col class="col" :span="2">
              <el-button size="mini" type="text" style="font-weight: 900;font-size: 16px;" icon="el-icon-plus"
                         @click="obj.argv.splice(index+1,0,{value:'',type:'string'})"></el-button>
            </el-col>
            <el-col class="col" :span="2">
              <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;"
                         icon="el-icon-close" @click="index>0?obj.argv.splice(index,1):(item.value='')"></el-button>
            </el-col>
          </el-row>
        </el-form-item>
      </el-form>
