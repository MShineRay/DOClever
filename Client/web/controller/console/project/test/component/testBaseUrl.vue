<template>
  <el-row class="row" style="height: 35px;line-height: 35px">
    <el-cascader size="mini" expand-trigger="hover" :options="arrProjectUrl" v-model="arrSelBaseUrl" style="width: 90%"
                 filterable clearable placeholder="请选择BaseUrl" :props="props" @change="change" @focus="focus">
    </el-cascader>
  </el-row>
</template>
