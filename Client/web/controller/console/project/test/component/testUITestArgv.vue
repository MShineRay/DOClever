    ...
    <el-row class="row">
      <el-row class="row" style="height: 50px;line-height: 50px;text-align: center" v-for="(item,index) in arr">
        ...
        <el-col class="col" :span="16">
          <el-input size="small" v-model="item.value" style="width: 90%" :placeholder="'请输入第'+index+'个参数'"
        ...
        <el-col class="col" :span="2">
          <el-button size="mini" type="text" style="font-weight: 900;font-size: 16px;" icon="el-icon-plus"
                     @click="arr.splice(index+1,0,{value:'',type:'string'})"></el-button>
        </el-col>
        <el-col class="col" :span="2">
          <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;" icon="el-icon-close"
                     @click="index>0?arr.splice(index,1):(item.value='')"></el-button>
        </el-col>
      </el-row>
    </el-row>
