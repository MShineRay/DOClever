    ...
    <table width="100%" id="queryTable">
      <template v-for="(item,index) in arr">
        <tr :style="{textAlign: 'center',verticalAlign: 'middle',backgroundColor:item.enable?'white':'lightgray'}">
          ...
          <td style="width: 25%;height: 50px;line-height: 50px">
            <div style="width: 90%;display: inline-block;"
              ...
              <el-autocomplete size="small" class="inline-input" v-model="item.selValue"
                               ...
                               :disabled="!item.enable || interface.example" style="width:100%"
            ...
            <el-input size="small" v-else style="width: 90%" v-model="item.selValue"
                      :disabled="!item.enable || interface.example"></el-input>
          </td>
          ...
          <td style="width: 15%">
            <el-button size="mini" type="text" style="font-size: 15px;" @click="toggleEnable(item,index)"
