  ...
  <el-row class="row">
    <el-row class="row" style="height: 35px;line-height: 35px">
      <el-button type="primary" size="mini" style="float: right;margin-top: 4px;margin-right: 5px;margin-left: 0px"
                 @click="poll" v-if="editRole">
        {{info.poll ? "编辑轮询" : "加入轮询"}}
      </el-button>
      <el-button type="primary" size="mini" style="float: right;margin-top: 4px;margin-right: 5px;margin-left: 0px"
                 @click="run" :loading="runPending">
        运行
      </el-button>
      <el-button type="primary" size="mini" style="float: right;margin-top: 4px;margin-right: 10px;margin-left: 0px"
                 @click="save" :loading="savePending" v-if="editRole">
        保存
      </el-button>
    ...
    <el-row class="row" style="height: calc(100vh - 150px);margin-top: 5px">
      <el-row class="row"
              style="border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.04);background-color: white;height: 66%;">
        <el-row class="row" style="height:40px;line-height: 40px;padding-left: 10px;font-size: 14px;color: #17B9E6">
          ...
          <el-button type="text" size="mini" style="float: right;margin-right: 10px;margin-top: 5px;color: red"
                     @click="clear">
            清空
          </el-button>
        ...
        <el-row class="row"
                style="height: calc(100% - 41px);border-bottom-left-radius: 5px;border-bottom-right-radius: 5px">
          <el-row class="row" style="height: 30px;line-height: 30px;text-align: center;background-color: #ebebeb"
          ...
          <el-row class="row"
                  style="height: calc(100% - 30px);overflow-y: auto;border-bottom-left-radius: 5px;border-bottom-right-radius: 5px"
                  id="collectionInfo">
            <el-row class="row" style="height: 40px;line-height: 40px;text-align: center;cursor: move"
                    v-for="(item,index) in arr" @mouseenter.native="$event.target.style.backgroundColor='#f3f3f3'"
                    @mouseleave.native="$event.target.style.backgroundColor='white'" draggable="true"
              ...
              <el-col class="col" :span="8" style="overflow: hidden;text-overflow:ellipsis;">
                <el-tooltip class="item" effect="dark"
                            :content="item.test.module.name+'/'+item.test.group.name+'/'+item.test.name"
                            placement="bottom">
...
" style="color: orange" v-else-if="item.status==4"></i>
      ...
      <el-row class="row" style="height:34%;padding: 15px 0">
        <el-row class="row"
                style="height: 100%;background-color: white;border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.04);">
          <el-row class="row" style="height:40px;line-height: 40px;padding-left: 10px;font-size: 14px;color: #17B9E6">
            输出
          </el-row>
          <el-row class="row" style="height: 1px;background-color: lightgray"></el-row>
          <el-row class="row"
                  style="height: calc(100% - 41px);border-bottom-left-radius: 5px;border-bottom-right-radius: 5px;overflow-y: auto;padding-left: 10px">
