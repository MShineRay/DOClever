<template>
  <el-row class="row">
    ...
    <el-row class="row" style="height: calc(100vh - 150px);overflow-y: auto;margin-top: 5px">
      <el-row class="row"
              style="background-color: white;border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.04);padding-bottom: 15px">
          ...
          <el-row class="row">
            <el-col class="col" :span="12">
              <el-form-item label="业务">
                <el-cascader size="small" expand-trigger="hover" :options="arrGroup" v-model="groupModel"
      ...
      <el-row class="row"
              style="background-color: white;margin-top: 15px;padding-bottom: 30px;border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.04);">
        <el-row class="row" style="height:40px;line-height: 40px;padding-left: 10px;font-size: 14px;color: #17B9E6">
          内容
