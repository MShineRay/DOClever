  ...
  <el-dialog title="导入项目" width="50%" ref="box" :visible.sync="showDialog" center append-to-body>
    <el-tabs v-model="type">
      ...
      <el-tab-pane name="postman" label="Postman">
        <el-input size="small" v-drag="'text'" type="textarea" :rows="5" placeholder="请输入JSON" v-model="text"
        ...
        <template v-for="(item,index) in arr">
          <el-row class="row" style="height: 50px;line-height: 50px;text-align: center">
            ...
            <el-col class="col" :span="2">
              <el-button type="text" size="small" style="color: red;font-size: 15px;" @click="remove(index)"
                         icon="el-icon-close"></el-button>
            </el-col>
            <el-col class="col" :span="2">
              <el-button style="font-size: 15px" v-if="index==arr.length-1" @click="arr.push({title:''})" size="small"
      ...
      <el-tab-pane name="swagger" label="Swagger">
        ...
        <el-input size="small" v-drag="'textSwaggerJSON'" type="textarea" :rows="5" placeholder="请输入Swagger Url"
                  v-model="textSwaggerJSON" v-show="swaggerType==1"></el-input>
      </el-tab-pane>
