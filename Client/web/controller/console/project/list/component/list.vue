<template>
  <el-row class="row">
    ...
    <tempalte v-else>
      ...
      <el-row class="row"
              style="margin: 10px 20px 10px 20px;width: calc(100% - 40px);height: calc(100vh - 175px);overflow-y: auto">
        <template v-if="!session.teamId">
          <expand :expand="1"
            ...
            <el-radio-group v-model="createSort" size="mini" slot="append" style="margin-right: 20px"
          ...
          <expand :expand="1"
            ...
            <el-radio-group v-model="joinSort" size="mini" slot="append" style="margin-right: 20px"
          ...
          <expand :expand="1"
                  style="background-color: white;margin-top: 20px;border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.04);"
                  v-if="arrPublic.length>0">
            <div slot="title" style="font-size: 14px">
              公开的项目
            </div>
            <el-radio-group v-model="publicSort" size="mini" slot="append" style="margin-right: 20px"
                            @change="changePublicSort">
              <el-radio-button :label="0">时间&nbsp;↓</el-radio-button>
              <el-radio-button :label="1">名称&nbsp;↑</el-radio-button>
            </el-radio-group>
            <el-row class="row">
        ...
        <expand :expand="1"
          ...
          <el-radio-group v-model="teamSort" size="mini" slot="append" style="margin-right: 20px"
                          @change="changeTeamSort">
            <el-radio-button :label="0">时间&nbsp;↓</el-radio-button>
            <el-radio-button :label="1">名称&nbsp;↑</el-radio-button>
          </el-radio-group>
          <el-row class="row">
