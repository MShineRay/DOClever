      ...
      <table style="width: 100%" class="table-hover">
        <template v-for="(item,index) in obj.data">
          <tr style="text-align: center;vertical-align: middle">
            ...
            <td style="width: 40%">
              <el-input size="small" style="width: 90%;margin: 0 auto" placeholder="请填写值"
            ...
            <td style="width: 10%">
              <el-button style="font-size: 15px" v-if="index==obj.data.length-1"
                         @click="obj.data.push({key:'',remark:''})" size="mini" type="text"
