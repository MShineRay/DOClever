  ...
  <el-dialog :title="propObj?'编辑':'新建'" fullscreen="true" ref="box" :visible.sync="showDialog" append-to-body>
    ...
    <el-row class="row">
      <el-col :span="12" class="col" style="border-right: 1px gray solid">
        <textarea v-tab style="height: 500px;width: calc(100% - 10px);border: none;margin: 0;padding: 0 5px 0 5px"
                  v-model="obj.content" placeholder="支持markdown语法编写" id="markdownEditor"></textarea>
      </el-col>
      <el-col :span="12" class="col">
        <vue-markdown :html="false"
                      style="height: 500px;width: 100%;padding-left: 5px;padding-right: 5px;overflow-y:auto"
                      :source="obj.content" id="markdownPreview"></vue-markdown>
      </el-col>
    </el-row>
