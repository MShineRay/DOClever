      ...
      <template v-for="(item,index) in arr">
        <tr style="text-align: center;vertical-align: middle;height: 50px">
          ...
          <td style="width: 10%;text-align: center">
            <el-button size="mini" @click="editRoleOption(item,index)" type="text" v-if="item.role==1 && manageRole">
              权限
            </el-button>
          </td>
          <td style="width: 10%;text-align: center">
            <el-button style="color:red;font-size: 15px" size="mini" icon="el-icon-close" @click="remove(item,index)"
                       type="text" v-if="manageRole"></el-button>
          </td>
        </tr>
      </template>
    </table>
