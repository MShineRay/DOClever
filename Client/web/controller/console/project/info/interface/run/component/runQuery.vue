          ...
          <td style="width: 25%;height: 50px;line-height: 50px">
            <div style="width: 90%;display: inline-block;"
              ...
              <el-autocomplete size="small" class="inline-input" v-model="item.selValue"
                               ...
                               :disabled="!item.enable" style="width:100%" popper-class="my-autocomplete">
            ...
            <el-input size="small" v-else style="width: 90%" v-model="item.selValue"
                      :disabled="!item.enable"></el-input>
          </td>
          <td style="width: 10%;height: 50px;">
            <el-button type="text" size="mini" style="font-size: 13px" @click="encrypt(item)">
              {{(item.encrypt && item.encrypt.type) ? item.encrypt.type : "未加密"}}
            </el-button>
          </td>
          <td style="width: 5%">
            <el-button size="mini" type="text" style="font-size: 15px;" @click="toggleEnable(item,index)"><span
