        ...
        <tr style="text-align: center;vertical-align: middle;cursor: move;height: 50px;line-height: 50px"
              ...
              <el-input size="small" style="width: 90%;"
                ...
                <el-dropdown slot="suffix" placement="bottom">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item @click.native="editStatus(item)"
                                      v-if="(item.type==0 || item.type==1) && statusExist">
          ...
          <td style="width: 20%">
            <el-tooltip class="item" effect="dark" :content="item.mock" placement="bottom" :disabled="!item.mock">
              <el-input size="small" style="width: 90%;height: 46px;line-height: 46px" placeholder="请填写Mock数据;"
                        v-model="item.mock" v-if="item.type!=4" @focus="focus(item)" @blur="blur(item)">
                <i slot="suffix" class="el-input__icon el-icon-edit" @click="editMock(item)"
                   style="cursor: pointer"></i>
              </el-input>
            </el-tooltip>
          </td>
          ...
          <td style="width: 5%">
            <el-button size="mini" type="text" style="font-size: 15px" icon="el-icon-plus" @click="add(arr,index)"
                       v-if="(item.type==2 || item.type==5 || item.type==0 || item.type==1)"></el-button>
            <el-dropdown v-else>
