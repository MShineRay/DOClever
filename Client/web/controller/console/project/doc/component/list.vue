<template>
  <el-row class="row" style="cursor: pointer;white-space: nowrap;background-color: white" id="docTree">
    <template v-for="(item,index) in group">
      <el-row class="row" :draggable="true" style="height: 35px;line-height: 35px;white-space: nowrap"
              ...
              @dragend.native="dragEnd($event)" :key="item._id" v-if="level==0 || (item.childDoc && parent.show)"
        ...
        <el-col class="col" :span="20-2*level"
                :style="{margin: 0,fontSize: '14px',color: 'gray',whiteSpace: 'nowrap',padding: 0,textOverflow:'ellipsis',overflow:'hidden',textDecoration:item.delete?'line-through':'none'}"
        ...
        <div class="col"
          ...
          <div style="height: 35px;line-height: 35px;display: inline-block;margin-right: 3px;float: right;">
            <i class="el-icon-delete"
               ...
               @click="removeGroup(item)" title="删除分组"></i>
          </div>
          <div style="height: 35px;line-height: 35px;display: inline-block;margin-right: 3px;float: right;">
            <i class="el-icon-plus"
               ...
               @click="addDoc(item)" title="新建文档"></i>
          </div>
        </div>
      </el-row>
      <el-collapse-transition>
        <docgrouplist v-if="item.show" :level="level+1" :group="item.childGroup" :doc="item.childDoc"
                      :parent="item"></docgrouplist>
      </el-collapse-transition>
    </template>
    <template v-for="(item,index) in doc">
      <el-row class="row" :draggable="true" style="height: 35px;line-height: 35px;"
              @mouseenter.native="mouseEnter($event,item)" @mouseleave.native="mouseLeave($event,item)"
        ...
        <el-col class="col" :span="20-2*level"
                :style="{fontSize:'14px',margin: 0,color:item.select?'white':'gray',lineHeight:'35px',textOverflow:'ellipsis',overflow:'hidden'}"
        ...
        <div class="col"
          ...
          <div style="height: 35px;line-height: 35px;display: inline-block;margin-right: 3px;float: right;">
            <el-dropdown style="height: 100%;cursor: pointer;float: right;margin-right: 3px">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>
                  <div @click="removeDoc(item,index)">删除</div>
                </el-dropdown-item>
                <el-dropdown-item>
                  <div @click="renameDoc(item,index)">重命名</div>
                </el-dropdown-item>
