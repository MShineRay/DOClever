  ...
  <el-row class="row" style="margin-top: 10px;font-size: 14px" id="doc">
    ...
    <el-tabs v-model="type" style="height: 50px;">
          ...
          <el-row class="row"
            ...
            <el-row class="row" style="height: 40px;line-height: 40px;color: #17b9e6;padding-left: 20px">
              ...
              <el-button size="mini" type="primary"
                         style="float: right;margin-right: 20px;margin-top: 5px;margin-left: 0px" @click="exportPdf">
                <i class="el-icon-download" style="font-weight: 900"></i>&nbsp;导出
              </el-button>
              <el-button size="mini" type="primary"
                         style="float: right;margin-top: 5px;margin-left: 0px;margin-right: 10px" @click="read">
                <i class="el-icon-tickets" style="font-weight: 900"></i>&nbsp;阅读
              </el-button>
              <el-button size="mini" type="primary" style="float: right;margin-top: 5px;margin-right: 10px"
                         @click="edit">
      ...
      <el-tab-pane name="setting" label="设置">
        <el-row class="row"
                style="padding: 10px 10px 60px 10px;height: calc(100vh - 115px);overflow-y: auto;font-size: 14px">
          <expand class="row"
                  style="border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.04);background-color: white">
                ...
                <el-row class="row">
                  <el-col class="col" :span="10">
                    <el-form-item label="公开到平台">
                      <el-switch v-model="doc.public" active-color="#13ce66" inactive-color="lightgray"
                                 :active-value="1" :inactive-value="0"></el-switch>
                    </el-form-item>
                  </el-col>
                  <el-col class="col" :span="10" v-if="session.teamId">
                    <el-form-item label="公开到团队">
                      <el-switch v-model="doc.publicTeam" active-color="#13ce66" inactive-color="lightgray"
                                 :active-value="1" :inactive-value="0"></el-switch>
                    </el-form-item>
                  </el-col>
                </el-row>
                  ...
                  <template v-for="(item,index) in users">
                    <tr style="text-align: center;vertical-align: middle;height: 50px">
                      ...
                      <td style="width: 20%;text-align: center">
                        <el-button style="color:red;font-size: 15px" size="mini" icon="el-icon-close"
                                   @click="remove(item,index)" type="text"></el-button>
                      </td>
                    </tr>
                  </template>
                </table>
