<template>
  <el-dialog title="设置项目所有者" width="50%" ref="box" :close-on-click-modal="false" :close-on-press-escape="false"
             :show-close="false" :visible.sync="showDialog" append-to-body>
