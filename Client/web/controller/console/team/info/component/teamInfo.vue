<template>
  <el-row class="row" style="height: calc(100vh - 115px);overflow-y: auto;padding:10px 10px 50px 10px"
          id="teamBasicInfo">
    <el-row class="row" style="text-align: center;height: 100px;font-size: 30px;cursor: pointer">
      <el-col class="col" :span="7">
        <el-row class="row"
                style="width: 90%;height: 100%;border: 1px #e1e1e1 solid;background-color: white;border-radius: 5px;padding-top: 30px;padding-bottom: 30px">
      ...
      <el-col class="col" :span="7">
        <el-row class="row"
                style="width: 90%;height: 100%;border: 1px #e1e1e1 solid;background-color: white;border-radius: 5px;line-height: 100px">
          {{userCount}}
          <div style="position: absolute;top:5px;left: 10px;color: gray;font-size: 12px;line-height: normal">
            成员:
          </div>
    ...
    <el-row class="row"
            style="border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.04);background-color: white;margin-top: 20px;">
    ...
    <el-row class="row"
      ...
      <el-row class="row" style="background-color: lightgray;height: 1px"></el-row>
      <el-row class="row" style="padding: 10px 20px 20px 20px">
        <el-button type="primary" size="mini" @click.stop="addNotice" v-if="manageRole" style="margin-bottom: 10px">新增
        </el-button>
          ...
          <el-row class="row" style="height: 120px">
            <template v-for="n1 in 4">
              <el-col class="col" :span="6" v-if="notice[(n-1)*4+(n1-1)]">
                <el-row class="row"
                        style="margin-top: 10px;margin-left: 10px;width: calc(100% - 20px);height: 100px;border: 1px lightgray solid;border-radius: 5px">
                  <el-row class="row" style="height: 70px;padding: 10px;font-size: 13px;overflow: auto;"
                          :title="notice[(n-1)*4+(n1-1)].content">
                  ...
                  <el-row class="row" style="height: 30px;line-height: 30px;padding-left: 10px">
                    ...
                    <el-col class="col" :span="6" style="text-align: right;padding-right: 10px">
                      <el-button type="text" size="mini" @click="removeNotice(notice[(n-1)*4+(n1-1)],(n-1)*4+(n1-1))"
