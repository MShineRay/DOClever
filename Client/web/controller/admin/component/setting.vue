<template>
  <el-row class="row">
    <el-col class="col" :span="6" style="padding: 0 10px 0 10px">
      <el-row class="row"
              style="background-color: white;text-align: center;border-radius: 5px;box-shadow: 0px 2px 2px #888888;padding-bottom: 20px">
        <el-button size="mini" type="primary" style="margin: 20px 0 0 0;width: 80%;" @click="type=0">
          修改管理密码
        </el-button>
        <el-button size="mini" type="primary" style="margin: 20px 0 0 0;width: 80%;" @click="type=1">
          系统设置
        </el-button>
        <el-button size="mini" type="primary" style="margin: 20px 0 0 0;width: 80%;" @click="type=2">
          数据备份
        </el-button>
      </el-row>
    </el-col>
        ...
        <el-row v-show="type==0" class="row">
          ...
          <el-form ref="form" label-width="100px">
            ...
            <el-row class="row" style="text-align: center">
              <el-button size="mini" type="primary" style="width: 60%;margin-top: 20px;margin-bottom: 20px"
                         @click.prevent="editPassword" :loading="passwordPending">
                保存
              </el-button>
            </el-row>
          </el-form>
        ...
        <el-row v-show="type==1" class="row" style="padding-bottom: 20px">
          ...
          <el-form ref="form" label-width="100px">
            ...
            <el-form-item label="注册">
              <el-switch v-model="setting.info.register" :active-value="1" :inactive-value="0" active-color="#13ce66"
                         inactive-color="#ff4949">
              </el-switch>
            </el-form-item>
            <el-row class="row" style="text-align: center">
              <el-button size="mini" type="primary" style="width: 60%;margin-top: 20px;margin-bottom: 20px"
                         @click="editInfo" :loading="infoPending">
                保存
              </el-button>
            </el-row>
          </el-form>
          ...
          <el-form ref="form" label-width="100px">
            <el-form-item label="数据库地址">
              <el-input size="small" style="width: 80%" v-model="setting.connect.db"
                        placeholder="请输入mongodb数据库地址（比如：mongodb://localhost:27017/DOClever)"></el-input>
            </el-form-item>
            <el-form-item label="上传文件地址">
              <el-input size="small" style="width: 80%" v-model="setting.connect.filePath"
                        placeholder="请输入DOClever上传文件路径（比如：/Users/Shared/DOClever）"></el-input>
            </el-form-item>
            </el-form-item>
            <el-form-item label="启动端口">
              <el-input size="small" style="width: 80%" v-model="setting.connect.port"
                        placeholder="请输入端口号（比如10000）"></el-input>
            </el-form-item>
            <el-row class="row" style="text-align: center">
              <el-button size="mini" type="primary" style="width: 60%;margin-top: 20px;margin-bottom: 20px"
                         @click="editConfig" :loading="configPending">
                保存
              </el-button>
            </el-row>
          </el-form>
        ...
        <el-row v-show="type==2" class="row" style="padding-bottom: 20px">
          ...
          <el-form ref="form" label-width="150px">
            ...
            <el-form-item label="立即备份一次">
              <el-switch v-model="immediate" :active-value="1" :inactive-value="0" active-color="#13ce66"
                         inactive-color="#ff4949"></el-switch>
            </el-form-item>
            <el-row class="row" style="text-align: center">
              <el-button size="mini" type="primary" style="width: 60%;margin-top: 20px;margin-bottom: 20px"
                         @click="backInfo" :loading="backPending">
                保存
              </el-button>
            </el-row>
          </el-form>
