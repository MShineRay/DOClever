        ...
        <table class="table-hover" style="width: 100%;">
          ...
          <template v-for="(item,index) in obj.own">
            <tr style="height: 50px;text-align: center;vertical-align: middle">
              ...
              <td style="width: 10%">
                <el-button size="mini" type="text" @click="transfer(item,index)" title="转让"><i
                  class="fa fa-sign-in"></i></el-button>&nbsp;&nbsp;
        ...
        <table class="table-hover" style="width: 100%;">
          ...
          <template v-for="(item,index) in obj.join">
            <tr style="height: 50px;text-align: center;vertical-align: middle">
              ...
              <td style="width: 10%">
                <el-button size="mini" type="text" icon="el-icon-close" style="color: red" @click="quit(item,index)"
                           title="退出"></el-button>
              </td>
            </tr>
          </template>
