  ...
  <el-row class="row" style="padding-bottom: 10px">
    <el-tabs tab-position="left" v-model="tabType">
      <el-tab-pane :name="0" label="接口">
        ...
        <el-row class="row"
                style="text-align: center;border-radius: 5px;box-shadow: 0px 2px 2px #888888;background-color: white;margin-top: 20px">
          <el-row class="row" style="height: 50px;line-height: 50px;border-bottom:1px lightgray solid">
            ...
            <el-col class="col" :span="16">
              <el-input size="small" style="width: 80%" placeholder="请输入你要查找的项目" v-model="project"
                        v-if="interfaceType==1"></el-input>
              <span v-else>
                        &nbsp;
                    </span>
            </el-col>
