<template>
  <el-row id="navBar" class="row" :style="{height:'50px','backgroundColor':'white'}"
          style="box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.15)">
    <slot name="other"></slot>
    <el-col class="col" :span="3"
            style="text-align: left;line-height: 50px;color:#50bfff ;font-size: 25px;padding-left: 20px">
    ...
    <el-col class="col" :span="8"
            style="text-align: center;line-height: 50px;font-size: 25px;color: #50bfff;white-space: nowrap;text-overflow:ellipsis">
      <slot name="title">
      </slot>
    </el-col>
    <el-col class="col" :span="2" style="text-align: center;line-height: 50px;">
