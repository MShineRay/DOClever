      ...
      <template v-for="(item,index) in arr">
        <tr style="text-align: center;vertical-align: middle">
          <td style="width: 20%;height: 50px">
            <el-autocomplete style="width: 90%" class="inline-input" placeholder="请填写header" v-model="item.name"
                             :fetch-suggestions="querySearchKey"></el-autocomplete>
          </td>
          <td style="width: 30%">
            <el-autocomplete style="width: 90%;" class="inline-input" placeholder="请填写value" v-model="item.value"
                             :fetch-suggestions="querySearchValue" @mouseenter.native="focus(item)"></el-autocomplete>
          </td>
          <td style="width: 50%">
            <el-input style="width: 90%;font-size: 15px" placeholder="请填写备注" v-model="item.remark"
