  ...
  <el-row class="row">
    ...
    <table width="100%" v-if="info.type==0">
      <template v-for="(item,index) in arr">
        <tr style="text-align: center;vertical-align: middle">
          ...
          <td style="width: 15%">
            <el-button type="text" size="small" @click="configValue(item)" v-if="item.type==0" style="font-size: 15px">
    ...
    <el-row class="row" style="height: 50px;line-height: 50px" v-else>
      <el-col class="col" :span="20" style="text-align: center">
        <el-input style="width: 90%;" placeholder="请填写备注" v-model="info.rawTextRemark" v-if="info.rawType==0"
                  :disabled="true"></el-input>
        <el-input style="width: 90%;" placeholder="请填写备注" v-model="info.rawFileRemark" v-else
                  :disabled="true"></el-input>
      </el-col>
      <el-col class="col" :span="4" style="text-align: center">
        <el-button type="text" size="small" @click="configRawValue" v-if="info.rawType==0" style="font-size: 15px">
